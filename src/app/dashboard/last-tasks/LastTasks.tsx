// components/last-tasks/LastTasks.tsx
	...
	return (
		<div className="bg-white dark:bg-neutral-800 rounded-3xl p-6 shadow-sm border border-neutral-200 dark:border-neutral-700">
			<div className="flex items-center justify-between mb-6">
				<h3 className="text-lg font-semibold text-[#2a2a2a] dark:text-[#f5f5f5]">Last Tasks</h3>
				<span className="text-sm text-neutral-500 dark:text-neutral-400">(3)</span>
			</div>
					...
					>
						<div className="flex items-start justify-between mb-3">
							<div className="flex items-center space-x-3">
								...
								<div>
									<h4 className="font-medium text-sm text-[#2a2a2a] dark:text-[#f5f5f5]">
										{task.title}
									</h4>
									<p className="text-xs text-neutral-500 dark:text-neutral-400">Due: 3 days</p>
								</div>
							</div>
						...
						<div className="flex items-center justify-between">
							...
							<span className="text-xs font-medium text-[#2a2a2a] dark:text-[#f5f5f5]">
								{task.progress}%
							</span>
						</div>
					</div>
