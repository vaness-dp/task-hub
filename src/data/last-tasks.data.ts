...
import type { ITaskFilter } from '@/components/dashboard/tasks/last-tasks/controls/task-filter/task-filter.types'

import type { ITask } from '@/types/task.types'

interface ITaskStatConfig {
	icon: LucideIcon
...
export const STATS_DATA: readonly ITaskStatConfig[] = [
